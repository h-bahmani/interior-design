...
const PRESET_PALETTES = [
  ...
  { id: "bold_dramatic", name: "Bold Dramatic", desc: "Deep navy, burgundy, brass", mood: "bold", colors: ["#1A2744", "#6B1E2E", "#B8924A", "#F0E8D8", "#0D1A33"] },
  { id: "pastel_soft", name: "Pastel Soft", desc: "Blush, lavender, mint", mood: "pastel", colors: ["#F2C4C4", "#C4B8D9", "#B8D9C4", "#F9F0F0", "#D9C4E8"] },
  { id: "moody_dark", name: "Moody Dark", desc: "Charcoal, slate, copper", mood: "dark", colors: ["#2D2D2D", "#4A4A5A", "#8B6B4A", "#1A1A2A", "#C4844A"] },
  { id: "coastal_fresh", name: "Coastal Fresh", desc: "Ocean blue, sandy white, driftwood", mood: "cool", colors: ["#4A8BA8", "#F5F0E0", "#C4A87A", "#7AB8D0", "#8B7355"] },
  ...
  { id: "spring_blossom", name: "Spring Blossom", desc: "Blush pink, mint, soft lilac", mood: "pastel", colors: ["#F5D6DC", "#D8ECD9", "#FBF6EE", "#E3D5F0", "#F0C9D0"] },
  ...
  { id: "sage_cream", name: "Sage & Cream", desc: "Sage green, cream, warm taupe", mood: "neutral", colors: ["#A3B18A", "#E9E5D6", "#F8F5EF", "#C9BBA8", "#7D8C64"] },
